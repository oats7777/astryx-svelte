  ...
  const packages: readonly PackageInfo[] = [
    {
      ...
      purpose: 'Svelte 5 components, theme runtime, docs metadata, plain CSS, and optional Tailwind CSS entrypoints.',
      visibility: 'public',
    },
    {
...
<main class="docs-shell">
  <header class="hero">
    <div class="hero-copy">
      ...
      <h1>Astryx Svelte</h1>
      <p>
        Svelte 5 implementation of the Astryx design system, including components,
        tokens, plain CSS and Tailwind entrypoints, CLI metadata, templates, and
        agent-facing docs.
      </p>
    </div>
