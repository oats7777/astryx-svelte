  ...
  const healthItems: readonly ListItem[] = [
    {
      ...
      description: 'Tailwind utilities resolve through the token bridge.',
      meta: 'CSS contract',
    },
    {
      id: 'components',
      label: 'Svelte package scanned',
      description: 'The app CSS explicitly registers package source with Tailwind.',
      meta: '@source',
    },
    {
      id: 'overlay',
