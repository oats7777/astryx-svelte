  ...
  sections: [
    {
      ...
      content: [
        ...
        {
          type: 'prose',
          text: 'Use Svelte 5. Tailwind v4 is optional for layout utilities, but recommended because `@astryxdesign/tokens/tailwind-theme.css` maps utilities to Astryx semantic tokens.',
        },
      ],
    },
    {
