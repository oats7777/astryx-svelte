...
export const docs = {
  ...
  title: 'Styling',
  category: 'guide',
  description: 'Customize Astryx Svelte with semantic CSS variables, component props, plain CSS, and optional Tailwind v4 utilities.',
  sections: [
    {
      ...
      content: [
        {
          ...
          items: [
            ...
            'Use plain CSS or CSS Modules for layout when Tailwind is not part of the app.',
            'Use Tailwind v4 semantic utilities for layout and local composition only when the app already uses Tailwind.',
