 ...
 * @param {string|null} [options.importHint] - Import path hint (e.g. '@astryxdesign/svelte/actions')
 */
export function formatFull(docs, options = {}) {
  const sections = [];
  const codeFence = options.codeFence || 'svelte';
 ...
 */
export function formatCompact(docs, componentName, importHint, options = {}) {
