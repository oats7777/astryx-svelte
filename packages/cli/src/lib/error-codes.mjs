...
export const ERROR_CODES = Object.freeze({
  ...
  /** `@astryxdesign/svelte` could not be located (not installed / not in a monorepo). */
  ...
  /** A component name matched more than one owner package. */
  ...
  /** A template id matched more than one type or owner package. */
  ...
  // ── Upgrade ──────────────────────────────────────────────────────
  /** The current `@astryxdesign/svelte` version could not be detected. */
