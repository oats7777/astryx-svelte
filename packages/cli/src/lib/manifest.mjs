 ...
 */
const EXAMPLES = {
  component: ['astryx component', 'astryx component Button', 'astryx component Button --props --json'],
  ...
  template: ['astryx template --json', 'astryx template app-shell ./src/routes'],
  hook: ['astryx hook', 'astryx hook useTheme --json'],
  ...
  init: ['astryx init'],
  'layout expand': [`astryx layout expand 'V[g6] > C{card-callout}*4' ./src/Page.svelte`],
