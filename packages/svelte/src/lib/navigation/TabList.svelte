...
<nav class="astryx-tab-list" aria-label={label} data-testid={testId}>
  {#each tabs as tab}
    <button
      type="button"
      class="astryx-tab-list__tab"
  ...
  {/each}
  {#if menu}
    <span class="astryx-tab-list__menu">
      <button
        type="button"
        aria-haspopup="menu"
      ...
      <div id={menuId} role="menu" aria-label={menu.label} hidden={!menuOpen} class="astryx-tab-list__menu-panel">
        {#each menu.options as option}
          <button
            type="button"
            role="menuitem"
            class="astryx-tab-list__menu-item"
