...
<script lang="ts">
  ...
  import {nextNavigationId} from './navigation-utils.js';
  ...
  const menuClass = 'astryx-nav-menu__panel';
...
<span class="astryx-nav-menu">
  <button
    bind:this={trigger}
    type="button"
    class="astryx-nav-menu__trigger"
    aria-haspopup="menu"
