...
export const docs = {
  ...
  description:
    'Svelte 5 and Tailwind CSS entrypoints for Astryx theme runtime, tokens, CSS, and implemented component surfaces.',
  exports: [
    '.',
    './Theme.svelte',
    './theme',
      ...
      content: [
        {
          ...
          items: [
            ...
            '`@astryxdesign/svelte/styles.css` imports Astryx token CSS and Tailwind v4 source registration.',
          ],
        },
      ],
    },
