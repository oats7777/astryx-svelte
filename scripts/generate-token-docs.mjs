...
sections.push({
  title: 'Usage in Svelte and Tailwind',
  content: [
    {
      type: 'code',
      lang: 'css',
...
@import "@astryxdesign/tokens/tailwind-theme.css";`,
  ...
  <p class="text-secondary">Token-backed utilities follow the active Astryx theme.</p>
    ...
    {
      type: 'prose',
      text: 'See `npx astryx docs styling` for component styling rules and `npx astryx docs theme` for overriding tokens with defineTheme.',
    },
  ],
});
