...
|README.md: Svelte 5, Tailwind v4, Astryx package usage, and CLI discovery guidance
|package.json: Representative dependencies for a consumer Svelte project
|src/app.css: Tailwind v4 token bridge and Astryx Svelte style imports
...
|Tailwind source: src/app.css declares @source for local .svelte/.ts files and Astryx Svelte package source
